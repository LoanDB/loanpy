...
def test_init():
    ...
    assert search_inst.donpath == None #5
    assert search_inst.recpath == None #6
...
def test_loans():
    ...
    'match':["blub"], 'recipdf_idx':[0], 'Meaning_x':["computer, interface"],
    'Meaning_y':["human"], 'gensim_multiword':[0.10940766]}),
    check_dtype=False)
