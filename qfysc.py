"""
Extract sound correspondence patterns from etymological data, \
and gives etymologies a likelihood-score based on extracted data.
"""
...
class Qfy(Etym):
    ...
    :param se_or_edict: Name of the dictionary containing the sum of examples or examples. \
    This data is only needed by loanpy.qfysc.Qfy().getnse() \
    and is generated by loanpy.qfysc.Qfy().dfetymology2dict()

    """
    def __init__(self, mode="adapt", scdictbase=None, struc_inv=None,
                 formscsv=None, srclg=None, tgtlg=None,
                 se_or_edict=None, vfb=None, connector=None, struc_most_frequent=9999999):
        """init Qfy with data from panphon and uralonet. If file missing set param to None"""

        super().__init__(formscsv=formscsv, srclg=srclg, tgtlg=tgtlg, struc_most_frequent=struc_most_frequent,
                         struc_inv=struc_inv)
