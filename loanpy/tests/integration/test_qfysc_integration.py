...
def test_align():
    ...
    qfy = Qfy()
    #assert
    assert_frame_equal(qfy.align(left="kala", right="hal"),
...
'j<j': 1, 'l<l': 1, 'n<n': 1, 't͡ʃ<t͡ʃː': 1, 'ɣ<ɣ': 2},
{'a<a': [1, 2, 3], 'd<d': [2], 'i<ɯ': [1], 'j<j': [3], 'l<l': [2], 'n<n': [3],
't͡ʃ<t͡ʃː': [1], 'ɣ<ɣ': [1, 2]},
{'VCCVC': ['VCCVC', 'VCVC', 'VCVCV'], 'VCVC': ['VCVC', 'VCCVC', 'VCVCV'],
'VCVCV': ['VCVCV', 'VCVC', 'VCCVC']},
